 ...
 */
package com.github.cstoku.neologd.unidic.lucene.analysis.ja;


import com.github.cstoku.neologd.unidic.lucene.analysis.ja.dict.*;
import com.github.cstoku.neologd.unidic.lucene.analysis.ja.tokenattributes.BaseFormAttribute;
import com.github.cstoku.neologd.unidic.lucene.analysis.ja.tokenattributes.InflectionAttribute;
import com.github.cstoku.neologd.unidic.lucene.analysis.ja.tokenattributes.PartOfSpeechAttribute;
import com.github.cstoku.neologd.unidic.lucene.analysis.ja.tokenattributes.ReadingAttribute;
...
public final class JapaneseTokenizer extends Tokenizer {
  ...
  private final EnumMap<Type, com.github.cstoku.neologd.unidic.lucene.analysis.ja.dict.Dictionary> dictionaryMap = new EnumMap<>(Type.class);
  ...
  private void add(com.github.cstoku.neologd.unidic.lucene.analysis.ja.dict.Dictionary dict, Position fromPosData, int endPos, int wordID, Type type, boolean addPenalty) throws IOException {
    ...
    for(int pos=startPos; pos < endPos; pos++) {
      ...
      if (pos == startPos) {
        ...
        for(int forwardArcIDX=0;forwardArcIDX<posData.forwardCount;forwardArcIDX++) {
          ...
          final com.github.cstoku.neologd.unidic.lucene.analysis.ja.dict.Dictionary dict2 = getDict(forwardType);
  ...
  com.github.cstoku.neologd.unidic.lucene.analysis.ja.dict.Dictionary getDict(Type type) {
